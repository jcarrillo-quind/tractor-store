 ...
 */
public record Product(String id, String name, String category, List<String> highlights, List<Variant> variants) {
	...
	public Product {
		...
		for (Variant v : variants) {
			if (!id.equals(v.productId())) {
				throw new IllegalArgumentException("Variant %s no pertenece al producto %s".formatted(v.sku(), id));
			}
		}
	}

	public static Product fromSeed(String id, String name, String category, List<String> highlights,
